...
class MainActivityViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _welcomeView = MutableLiveData<Boolean>()
    val welcomeView: LiveData<Boolean> get() = _welcomeView

    private val _permissionRationaleView = MutableLiveData<Boolean>()
    val permissionRationaleView: LiveData<Boolean> get() = _permissionRationaleView
    ...
    fun setWelcomeView(value: Boolean) {
        _welcomeView.value = value
    }

    fun setPermissionRationaleView(value: Boolean) {
        _permissionRationaleView.value = value
    }
     ...
     */
    fun loadImages() {
        println("KOTLINCLASS: loadImages")
    ...
    private suspend fun queryImages(): List<MediaStoreImage> {
        ...
        println("KOTLINCLASS: queryImages")
        /**
